...
tab_dashboard, tab_analytics, tab_history, tab_about = st.tabs(
    ["Dashboard", "Analytics", "History", "About"]
)
...
with tab_dashboard:
    ...
    if image and uploaded_bytes:
        ...
        with col_result:
            ...
            st.markdown(
                f"<span class='{badge_class}'>{result}</span>"
        ...
        <div class='{card_class}'>
            ...
            <ul style='color:#c8e6c9;margin-top:10px;padding-left:18px'>{tips_html}</ul>
        </div>
        """, unsafe_allow_html=True)
        ...
        fig = make_pie_figure(pie_values, ["#4caf50", "#ffca28", "#8d6e63"], ["Green", "Yellow", "Brown"])
        st.pyplot(fig)
        plt.close(fig)
        ...
        st.info("Upload an image or use your camera above to scan a leaf.")
...
with tab_analytics:
    ...
    if st.session_state.history:
        ...
        with col_pie:
            ...
            ax2.pie(
                [good_count, bad_count], labels=["GOOD", "BAD"], autopct="%1.1f%%",
        ...
        with col_bar:
            ...
            ax3.legend(
                handles=[mpatches.Patch(color="#4caf50", label="GOOD"), mpatches.Patch(color="#ef5350", label="BAD")],
...
with tab_history:
    ...
    if st.session_state.history:
        ...
        for idx, item in enumerate(st.session_state.history, 1):
            ...
            card_class_h = f"treatment-card {t_data['card_class']}".strip()
            ...
            <div class='agro-card'>
                ...
                <details>
                    ...
                    <div class='{card_class_h}' style='margin-top:10px'>
...
# ABOUT
with tab_about:
    st.markdown("#### About AgroVision AI")
    ...
    with left_col:
        ...
        <div class='agro-card'>
            ...
            Severity meter — Low / Medium / High Risk<br>
